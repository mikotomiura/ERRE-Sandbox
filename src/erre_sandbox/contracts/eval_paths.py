...
This module is the **API contract** layer of the 4-layer defence
(DuckDB single-file + named schema + 4-layer contract):
...
This contract is a behavioural one, not a path-only convention — grep alone cannot catch
