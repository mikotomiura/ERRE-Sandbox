...
| 4 | Godot avatar 30Hz 歩行 | ✅ PASS | `evidence/godot-walking-20260420-003400.mp4` (MacBook 収録、515KB ISO MP4v2、Kant avatar が peripatos↔study を visible に移動する様子を確認) |
...
の合計で、**MASTER-PLAN §4.4 の 4 検収項目すべてが実機 evidence 付きで PASS**。
Godot 録画 evidence は Mac 側 follow-up commit (`chore/t21-godot-walking-evidence` branch)
で push 済。**GAP-1 は T21 で完全解消**し、MVP 機能的完了が正式に成立する。
