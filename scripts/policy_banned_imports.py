#!/usr/bin/env python3
"""SH-1 banned-import scanner (CI backstop).

A local pre-commit / IDE hook can enforce the same rules at edit time;
this scanner is the CI counterpart so a forbidden import that slips past
local checks still fails the PR.
